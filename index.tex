...
\caption{\label{fig:org465ff1c}\href{https://janboone.github.io/European-Healthcare-Systems/figures/gdp\_mortality\_fit.html}{Model fit in terms of log treatable mortality and log GDP per head.}}
\end{figure}



\subsection{main specification}
\label{sec:org49dd7f9}

\begin{table}[htbp]
\caption{\label{tab:orga35a18c}Summary posterior distributions of the model's parameters}
\centering
...
\begin{table}[htbp]
\caption{\label{tab:org727f13b}Summary posterior distributions of the extended model's parameters}
\centering
\begin{tabular}{lrrrrrr}
coefficient & mean & sd & hpd\_3\% & hpd\_97\% & ess\_mean & r\_hat\\
\hline
...
\caption{\label{fig:orgbd30f33}Trace plot for parameters related to health}
\end{figure}


\subsubsection{efficiency}
\label{sec:orgb93a60c}

The traces for the variables related to efficiency are summarized in Figure \ref{fig:org599694f}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./figures/trace_efficiency.png}
\caption{\label{fig:org599694f}Trace plot for parameters related to efficiency}
\end{figure}

\subsubsection{market}
\label{sec:org27a793e}

The trace plots for the variables related to the market are presented in Figure \ref{fig:orgb8d98e4}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./figures/trace_market.png}
\caption{\label{fig:orgb8d98e4}Trace plot for parameters related to market}
\end{figure}


\subsubsection{quality}
\label{sec:org17b726e}

The trace plots for the healthcare regulator and yearly publishing of provider quality reports are presented in Figure \ref{fig:org5b3ca24}.

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./figures/trace_quality.png}
\caption{\label{fig:org5b3ca24}Trace plot for parameters related to quality}
\end{figure}
...
\begin{table}[htbp]
\caption{\label{tab:org5d93236}Summary posterior distributions of the model's parameters with life years lost}
\centering
\begin{tabular}{lrrrrrr}
coefficient & mean & sd & hpd\_3\% & hpd\_97\% & ess\_mean & r\_hat\\
\hline
