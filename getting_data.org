...
As the older year does not overlap with the years of our data, we choose the year 2015.
...
The year 2019 falls outside the range of our other variables. Hence we choose only data for 2014.
